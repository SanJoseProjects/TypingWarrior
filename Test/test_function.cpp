...
#include "../src/thirdwindow.cpp"
#include "../src/thirdwindow.h"
...
{
    ThirdWindow test;
    QCOMPARE(test.open_file(":/t/test.txt"), "Function is working.");
    QCOMPARE(test.open_file(":/t/test1.txt"), "ERROR FILE IS NOT CHOSEN");
}
